...
This desaturated-blue-coloured icons theme Suru++ Telinkrin (former Telinkrin Icons Theme) was designed by <a href="http://opendesktop.org/member/455718">Paulxfce</a> and now redesigned and powered by [Suru++ Project](https://github.com/suru-plus) and [Andrea Bonnani](https://github.com/Magog64)'s Suru++. It is designed for users who use Telekrin GTK as desktop theme. 
...
GPL3 © Suru++ Telinkrin by Andrea Bonanni, Paulxfce and Suru++ Project.