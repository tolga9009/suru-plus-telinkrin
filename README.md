...
This desaturated-blue-coloured icons theme was designed by <a href="http://opendesktop.org/member/455718">Paul Beyens</a> and now redesigned and powered by [Suru++ Project](https://github.com/suru-plus) and [Andrea Bonnani](https://github.com/Magog64)'s Suru++. It is designed for users who use Telekrin GTK as desktop theme. 
...
LGPL3 © Suru++ Telinkrin by Paul Beyens, Andrea Bonnani and Suru++ Project
