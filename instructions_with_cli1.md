...
svn export https://github.com/suru-plus/suru-plus-telinkrin/trunk/ ~/.icons/Suru++\ Telinkrin
# When we will update the icons, and if you want to update the icons, just overwrite
svn export --force https://github.com/suru-plus/suru-plus-telinkrin/trunk/ ~/.icons/Suru++\ Telinkrin
```
